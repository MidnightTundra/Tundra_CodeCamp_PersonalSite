...
document.addEventListener('scroll', function () {
    jQuery(function ($) {
        windowValue = $(window).scrollTop();

        for (let i = 0; i < universalArray.length; i++) {
            if ($(universalArray[i]).scrollTop() < windowValue) {
                $(buttonOverlay).removeClass('hideClass');
                $(buttonOverlay).addClass('fadeInClass');
            } 
            else if($(universalArray[i]).scrollTop() > windowValue) {
                $(buttonOverlay).addClass('hideClass');
                $(buttonOverlay).removeClass('fadeInClass');
            }
        }
